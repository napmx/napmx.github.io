...
> **참고**: nap mx 파트너 사이트에 가입 후 미디어 등록 및 애드유닛 생성을 완료해야 media key와 adunit id를 확인할 수 있습니다. media key와 adunit id가 파트너 사이트에 등록된 내용과 상이할 경우 광고가 원활히 노출되지 않을 수 있습니다.
...
| 항목 | 발급 방법 |
|------|----------|
| **media key** | [nap mx 파트너 사이트](https://publisher.admixer.co.kr)에서 미디어 등록 후 발급 |
